...
<head>
    <title>500</title>
    <link rel="stylesheet" href="${pageContext.request.contextPath}/plugins/500/500.css">
...
<div class="main-error-page">
    ...
    <h2 class="error-subtitle">
        服务器资源好像开小差了，访问其他资源试一下吧!
    </h2>
    <button type="button" class="btn bg-maroon-active" style="cursor: pointer"
