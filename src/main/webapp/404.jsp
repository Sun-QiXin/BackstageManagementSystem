...
<head>
    <title>403</title>
    <script src="${pageContext.request.contextPath}/plugins/403/403.js"></script>
    <link rel="stylesheet" href="${pageContext.request.contextPath}/plugins/403/403.css">
...
<div class="denied__wrapper">
    <h1>404</h1>
    <h3>哇！ <span>出错了! </span> &nbsp;我们没有这个资源奥！</h3>
    ...
    <div style="position: relative">
        <button type="button" class="btn bg-maroon-active" style="cursor: pointer;position: relative;left: calc(50% - 34px);"
                onclick="location.href='${pageContext.request.contextPath}/index.jsp'">返回主页
        </button>
    </div>
</div>
</body>
