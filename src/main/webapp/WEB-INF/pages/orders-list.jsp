                ...
                <div class="box-footer bg-light-blue" style="height: 50px;padding: 8px;line-height: 36px">
                    ...
                    <div class="box-tools pull-right">
                        <ul class="pagination" style="height: 30px;margin: 0;padding: 0">
                            <li>
                                <a href="${pageContext.request.contextPath}/orders/findAllOrders?page=1&pageSize=${pageInfo.pageSize}"
                                   aria-label="Previous">首页</a></li>
                            <li>
                                <a href="${pageContext.request.contextPath}/orders/findAllOrders?page=${pageInfo.prePage}&pageSize=${pageInfo.pageSize}">上一页</a>
                            </li>
                            ...
                            <c:if test="${pageInfo.pages<=10}">
                                ...
                                <c:forEach begin="1" end="${pageInfo.pages}" var="pageNum">
                                    <c:if test="${pageInfo.pageNum != pageNum}">
                                        <li>
                                            <a href="${pageContext.request.contextPath}/orders/findAllOrders?page=${pageNum}&pageSize=${pageInfo.pageSize}">${pageNum}</a>
                                        </li>
                                    </c:if>

                                    <c:if test="${pageInfo.pageNum == pageNum}">
                                        <li>
                                            <a href="${pageContext.request.contextPath}/orders/findAllOrders?page=${pageNum}&pageSize=${pageInfo.pageSize}"
                            ...
                            <li>
                                <a href="${pageContext.request.contextPath}/orders/findAllOrders?page=${pageInfo.nextPage}&pageSize=${pageInfo.pageSize}">下一页</a>
                            </li>
                            <li>
                                <a href="${pageContext.request.contextPath}/orders/findAllOrders?page=${pageInfo.pages}&pageSize=${pageInfo.pageSize}"
...
<script>
    ...
    function changePageSize() {
        ...
        //向服务器发送请求，改变没页显示条数
        location.href = "${pageContext.request.contextPath}/orders/findAllOrders?page=1&pageSize="
            + pageSize;
    }
